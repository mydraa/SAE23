...
--
-- Client :  localhost
-- Généré le :  Jeu 18 Juin 2026 à 14:03
...
--
ALTER TABLE `capteur`
ADD CONSTRAINT `fk_capteur_salle` FOREIGN KEY (`nom_salle`) REFERENCES `salle` (`nom_salle`) ON DELETE CASCADE;

--
-- Contraintes pour la table `mesure`
--
ALTER TABLE `mesure`
ADD CONSTRAINT `fk_mesure_capteur` FOREIGN KEY (`nom_capteur`) REFERENCES `capteur` (`nom_capteur`) ON DELETE CASCADE;

--
-- Contraintes pour la table `salle`
--
ALTER TABLE `salle`
ADD CONSTRAINT `fk_salle_batiment` FOREIGN KEY (`ID`) REFERENCES `batiment` (`ID_bat`) ON DELETE CASCADE;
